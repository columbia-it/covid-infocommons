...
from apis.models import Dataset
...
class PersonDocumentTest(TestCase):
    ...
    def test_fields_populated(self):
        ...
        self.assertEqual(set(mapping.properties.properties.to_dict().keys()), {'id','first_name','last_name','full_name', 'orcid','emails','private_emails','desired_collaboration','comments','approved', 'affiliations', 'keywords', 'websites'})
    ...
    def test_mapping(self):
        print('*****')
        print(PersonDocument._doc_type.mapping.to_dict())
        print('*****')
        self.assertEqual(
