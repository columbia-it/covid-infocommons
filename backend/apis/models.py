...
class Grant(models.Model):
    ...
    funder = models.ForeignKey(Funder, on_delete=models.SET_NULL, db_column='funder', null=True, blank=True)
    ...
    principal_investigator = models.ForeignKey(Person, on_delete=models.SET_NULL, blank=True, null=True, related_name='grant_pi')
    other_investigators = models.ManyToManyField(Person, blank=True, related_name='grant_other_investigators')
    awardee_organization = models.ForeignKey(Organization, on_delete=models.SET_NULL, null=True, blank=True)
