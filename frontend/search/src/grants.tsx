  ...
  <Box
    ...
    <div className='root'>
      ...
      <div className='flex-container'>
		...
		<span style={{backgroundColor: '#D8D8D8', padding: '3px'}}><b>Visit the <a href="/adv_search">Advanced Search page</a> to find datasets and publications related to your keyword search.</b></span>
        </div> 
