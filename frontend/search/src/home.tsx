...
class Home extends Component<HomeProps, HomeState> {
    ...
    componentDidUpdate = (prevProps:HomeProps) => {
        ...
        //   })
        // }
        if(this.props.keyword != prevProps.keyword) // Check if the total number of datasets has changed
        {
          this.setState({
            //   total_datasets: this.props.total_datasets,
            //   datasets: this.props.datasets,
    ...
    // get_total_grants = () => {
    //     var url = this.state.url.concat('/search/grants/count')
    //     axios.get(url, {params: {}}).then(results => {
    //       this.setState({ total_grants: results.data.count })
    //     })
    //     this.get_grants()
    //   }
    ...
    get_grants = (keyword?:string) => {
        ...
        axios.get(url, {params: params}).then(count_result => {
            this.setState({ total_grants: count_result.data.count })
    ...
    // get_total_people = () => {
    //     var url = this.state.url.concat('/search/people/count')
    //     axios.get(url, {params: {}}).then(results => {
    //       this.setState({ total_people: results.data.count })
    //     })
    //     this.get_people()
    // }
